...
The staff of the ACL Anthology would like to acknowledge all of the contributors
and institutions that make this collection of scholarly papers freely available
to all. The Anthology is only maintained by volunteers and the community's help
is what continues to make this resource the landmark that it is.
...
Thanks to the European Language Resources Association (ELRA) for allowing us to
link to the International Conference on Language Resources and Evaluation
proceedings series (LREC).

Thanks to the Machine Translation Archive for allowing us to link to their
scanned copies of the *Mechanical Translation and Computational Linguistics*
journal, the precursor to the current *Computational Linguistics* journal.

Thanks to Robert Amsler for his generous help and support of compiling the
listing of the Finite String newsletter.
