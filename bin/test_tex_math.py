...
test_cases_unicode = (('<tex-math>K</tex-math>-Embeddings: Learning Conceptual Embeddings for Words using Context',
...
test_cases_html = (('<tex-math>K</tex-math>-Embeddings: Learning Conceptual Embeddings for Words using Context',
 ...
 ('<tex-math>L_0</tex-math>-norm',
  '<span class="tex-math">L<sub>0</sub></span>-norm'),
 ...
 ('<tex-math>O(n^6)</tex-math> ',
  '<span class="tex-math">O(n<sup>6</sup>)</span> '),
 ('<tex-math>^{\\circ}</tex-math>: A Referring Expression Recognition Dataset in 360',
 ...
 ('<tex-math>Q^{2}</tex-math>: ',
  '<span class="tex-math">Q<sup>2</sup></span>: '),
 ('<tex-math>l_{0}</tex-math>-norm-based Alignment',
 ...
 ('<tex-math>O(\log_2 n)</tex-math>', '<span class="tex-math">O(<span class="tex-math-function">log</span><sub>2</sub> n)</span>'),
 ('<tex-math>\mathbf{^2}</tex-math>', '<span class="tex-math"><strong><sup>2</sup></strong></span>'),
 ('<tex-math>RoBERTa_{large}</tex-math>', '<span class="tex-math">RoBERTa<sub>large</sub></span>'),
 ('<tex-math>\\ell_1</tex-math>', '<span class="tex-math">ℓ<sub>1</sub></span>'),
 ('<tex-math>n \\log_2 \\frac{m}{n} + o(m)</tex-math>', '<span class="tex-math">n <span class="tex-math-function">log</span><sub>2</sub> <sup>m</sup>⁄<sub>n</sub> + o(m)</span>'),
 ('<tex-math>\textrm{Pr}(f_1^J/e^I_1)</tex-math>', '<span class="tex-math">\textrmPr(f<sub>1</sub><sup>J</sup>/e<sup>I</sup><sub>1</sub>)</span>'),
 )


def test_unicode():
  for inp, out in test_cases_unicode:
