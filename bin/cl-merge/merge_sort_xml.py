...
"""
Modified to retain all papers from both files
and to sort output file by paper id
...
exclude_elements = { } # papers are usually removed for a reason; don't put them back
