...
test_cases_html = (('<tex-math>K</tex-math>-Embeddings: Learning Conceptual Embeddings for Words using Context',
 ...
 ('<tex-math>0(n^{\\tilde{\\rho}+1})</tex-math>','<span class="tex-math">0(n<sup> ̃𝜌+1</sup>)</span>'),
 ('<tex-math>\\{mt, src\\} \\rightarrow pe</tex-math>', '<span class="tex-math">{mt, src} → pe</span>'),
 ('<tex-math>p(\\boldsymbol{y}|\\textrm{do}(\\boldsymbol{x}))</tex-math>', '<span class="tex-math">p(<strong>y</strong>|<span>do</span>(<strong>x</strong>))</span>'),
